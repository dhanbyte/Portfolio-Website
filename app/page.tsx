...
import { ArrowDown, Github, Linkedin, Mail, ExternalLink, Download, Moon, Sun } from "lucide-react"
...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Microservices API gateway with rate limiting, authentication, and comprehensive logging.",
      image: "/placeholder.svg?height=200&width=300",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      company: "StartupHub",
      role: "Founder",
      content: "Transformed our business with a custom dashboard. Great communication and problem-solving skills.",
      rating: 5,
      image: "/placeholder.svg?height=60&width=60",
    },
    {
      ...
      company: "PropTech Co.",
      role: "CEO",
      content: "Built our real estate platform from scratch. Impressive technical skills and business understanding.",
      rating: 5,
      image: "/placeholder.svg?height=60&width=60",
    },
    {
      ...
      content: "Delivered a robust API gateway that scaled perfectly. Would definitely work with again.",
      rating: 5,
      image: "/placeholder.svg?height=60&width=60",
    },
  ]
        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Full-Stack Developer who builds modern web applications with React, Node.js, and cutting-edge technologies
            </p>
            ...
            >
              <div className="space-y-6">
                <p className="text-lg leading-relaxed">
                  I'm a dedicated full-stack developer who loves creating digital experiences that make a difference.
                  With expertise in modern web technologies, I've successfully delivered projects for 5+ clients across
                  various industries.
                </p>
                <p className="text-lg leading-relaxed">
                  My journey started with curiosity about how websites work, and it evolved into a passion for building
                  scalable, user-friendly applications. I specialize in React, Node.js, and cloud technologies, always
                  staying updated with the latest industry trends.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Badge variant="secondary">5+ Happy Clients</Badge>
                  <Badge variant="secondary">20+ Projects Completed</Badge>
      ...
      <section id="skills" className="py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">Technologies I work with to bring ideas to life</p>
          </motion.div>
            ...
            >
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>dhananjay@example.com</span>
                  </div>
                  <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  I typically respond to emails within 24 hours. For urgent projects, feel free to mention it in your
                  message.
                </p>
              </div>
            </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-muted-foreground">© 2024 Dhananjay. All rights reserved.</p>
            </div>
