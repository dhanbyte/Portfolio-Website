        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Full-Stack Developer who creates modern web applications that bring ideas to life
            </p>
            ...
            >
              <div className="space-y-6">
                <p className="text-lg leading-relaxed">
                  I'm a dedicated full-stack developer who loves bringing ideas to life through code. With expertise in
                  modern web technologies, I've successfully delivered projects for 10+ clients across various
                  industries.
                </p>
                <p className="text-lg leading-relaxed">
                  My journey combines technical excellence with creative vision. I specialize in React, Node.js, cloud
                  technologies, and modern web development practices. I stay updated with the latest industry trends to
              ...
              <div className="rounded-2xl bg-gradient-to-br from-blue-400 to-purple-600 p-1">
                <div className="w-full rounded-2xl bg-background flex items-center justify-center">
                  <img
                    ...
                    alt="Dhananjay - Full Stack Developer"
                    loading="lazy"
                  />
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-muted-foreground">© 2024 Dhananjay.me - Full Stack Developer. All rights reserved.</p>
            </div>
