...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "Bazaar Buddy",
      description:
        "Modern e-commerce platform for browsing, filtering, and exploring product listings with detailed descriptions, shopping cart functionality, and smooth shopping experience.",
      image:
